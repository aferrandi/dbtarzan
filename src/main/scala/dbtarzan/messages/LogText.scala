...
object LogText {
	/* short description */
	def extractLogMessage(msg : TLogMessageGUI) : String = msg match {
	...
	def extractLogPrefix(msg : TLogMessageGUI) : String =msg match {
		case _: Error => "E"
		case _: Warning => "W"
		case _: Info => "I"
	}
	...
	def extractWholeLogText(msg : TLogMessageGUI) : String =  msg match {
