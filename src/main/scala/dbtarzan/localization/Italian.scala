...
class Italian extends Localization {
    ...
    def areYouSureSaveComposite = "Sicuro di voler salvare le combinazioni?"
    def saveConnections = "Salva le connessioni"
    def saveComposites = "Salva le combinazioni"
    ...
    def loadedTables(amount : Int, databaseName : String): String = "Caricate "+amount+" tabelle dal database "+databaseName
    def openingDatabase(databaseName : String): String = "Sto aprendo il database "+databaseName
    def loadingForeignKeys(fileName : String): String = "Sto caricando le chiavi esterne dal file dei database "+fileName
    def savingForeignKeys(fileName : String): String = "Sto salvando le chiavi esterne nel file dei database "+fileName
    ...
    def errorReadingKeys(databaseName : String): String = "Nella lettiura del file delle chiavi esterne del database "+databaseName+" si e' avuto il seguente errore. Cancella il file se e' corrotto o di una vecchia versione dell'applicazione."
    def errorWritingKeys(databaseName : String): String = "Nella scrittura del file delle chiavi esterne del database  "+databaseName+" si e' avuto il seguente errore. Verifica che il file non sia aperto in un'altra applicazione"
    def errorDisplayingConnections = "La visualizzazione delle connessioni e' fallita a causa di"
    def errorDisplayingComposites = "La visualizzazione delle combinazioni e' fallita a causa di"
    def errorSavingConnections = "Il salvataggio delle connessioni e' fallito a causa di"
    def errorSavingComposites = "Il salvataggio delle combinazioni e' fallito a causa di"
    ...
    def errorAFKSameColumns(sameColumns: List[String]): String = "Stesse colonne da e a in "+sameColumns.mkString(", ")
