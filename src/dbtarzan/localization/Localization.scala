...
trait Localization {
    ...
    def errorDuplicateAdditionalForeignKeys(nameDuplicates : List[String], relationDuplicates : List[String]) : String
    def errorAlreadyExistingAdditionalForeignKeys(names : List[String]) : String
}
